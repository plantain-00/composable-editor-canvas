...
import { Combination7 } from './combination-7'
import { Combination8 } from './combination-8'
...
const combinations = [
  ...
  { path: 'combination7', name: 'combination 7', component: Combination7 },
  { path: 'combination8', name: 'combination 8', component: Combination8 },
]
