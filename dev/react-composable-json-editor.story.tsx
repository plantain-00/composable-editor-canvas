...
import { useJsonEditorData, BooleanEditor, ObjectEditor, StringEditor, NumberEditor, ArrayEditor, EnumEditor, ObjectArrayEditor, DialogContainer, EnumArrayEditor } from '../src'
...
export default () => {
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      <br />
      <div style={{ height: '400px', margin: '10px', position: 'absolute', overflowY: 'auto' }}>
        <ObjectEditor
          properties={{
      ...
      <div style={{ margin: '10px', position: 'absolute', top: '450px' }}>
